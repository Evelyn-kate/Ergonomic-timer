...
public class TopSessionsAdapter extends ArrayAdapter<Session> {
    ...
    public View getView(int position, View listItemView, ViewGroup parent){
        ...
        TextView nameSession = listItemView.findViewById(R.id.sessionList);
        nameSession.setText(currentSession.getName().toString());
        TextView day = listItemView.findViewById(R.id.sessionDay);
        day.setText(currentSession.getDay().toString());

        ImageButton imageButton =  listItemView.findViewById(R.id.completeButtonList);
