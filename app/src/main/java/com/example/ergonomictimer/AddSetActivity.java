...
public class AddSetActivity extends MainMenu implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addPoseToSessionButton = findViewById(R.id.addPoseToSessionButton);
        loadPosesToSpinner();
    }
